...
const SocialIcons = (props) => {
  return (
    <div className={styles.SocialIconsContainer}>
      <a
        className={styles.SocialLink} target="_blank"
        rel="noopener noreferrer" href={URL.externalUrls.facebook}
      >
        <FontAwesomeIcon className={styles.Icon} icon={faFacebook} />
      </a>
      <a
        className={styles.SocialLink} target="_blank"
        rel="noopener noreferrer" href={URL.externalUrls.twitter}
      >
        <FontAwesomeIcon className={styles.Icon} icon={faTwitter} />
      </a>
      <a
        className={styles.SocialLink} target="_blank"
        rel="noopener noreferrer" href={URL.externalUrls.pinterest}
      >
        <FontAwesomeIcon className={styles.Icon} icon={faPinterest} />
      </a>
      <a
        className={styles.SocialLink} target="_blank"
        rel="noopener noreferrer" href={URL.externalUrls.instagram}
      >
        <FontAwesomeIcon className={styles.Icon} icon={faInstagram} />
      </a>
      <a
        className={styles.SocialLink} target="_blank"
        rel="noopener noreferrer" href={URL.externalUrls.etsy}
      >
